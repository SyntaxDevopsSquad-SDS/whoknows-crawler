...
## Deployment
The crawler runs in Docker on a Digital Ocean droplet. Deployments are automated via GitHub Actions – any push to `main` that changes `crawler.py` will automatically SSH into the server and redeploy the container.
